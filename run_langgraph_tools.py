...
# Importáljuk a LangGraph tool integrátort
from tools.langgraph_integration import tool_graph_integrator
...
if __name__ == "__main__":
    ...
    if "tasks" in result:
        for i, task in enumerate(result["tasks"]):
            ...
            result_status = 'Sikeres' if isinstance(task['result'], dict) and task['result'].get('success', False) else 'Sikertelen'
            print(f"  Eredmény: {result_status}")
