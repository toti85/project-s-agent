...
class LangGraphIntegrator:
    ...
    async def handle_workflow_command(self, command: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        # This functionality is now implemented in langgraph_router.py
        # Keeping this method for backward compatibility
        from integrations.langgraph_router import handle_workflow_command
        return await handle_workflow_command(command)